...
$msg="";
if (isset($_POST['add'])) {
    if ($_POST['type']!="" AND $_POST['Debut']!="" AND $_POST['Fin']!="" AND $_POST['Jours']!="" AND $_POST['description']!="") {
    ...
    $msg="Votre demande est envoyee avec success";    
          ...
          $msg="Vous avez obligatoire d'entrer les jours positif ou superieur a zero";   
        }
       
    }else{
      $msg="Vous avez depasser 4 jours de votre conge de circonstance ";
    }       
...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Nouveau Demande Circonstance</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Type Congé</label>
                                                         <select class="form-control"  name="type">
                                                        <option >Choose LeaveType</option>
                                                        <option value="Mariage">Mariage</option>
                                                      <option value="Deces du conjoint,...">Deces du conjoint,...</option>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Nombre de Jours</label>
                                                        <input type="number" id="nbJours" name="Jours" type="number" class="form-control cc-exp" autocomplete="off" required="" >
 ...
 <script >
    ...
    function (){
        ...
        var nbJours=parseInt(document.getElementById("nbJours").value);
        var dateFin=new Date(dateDebut);
        dateFin.setDate(dateFin.getDate()+nbJours).innerHTML=dateFin;

        document.getElementById("dateFin").value=dateFin.toISOString().slice(0,10);
    });
    document.getElementById("nbJours").addEventListener("change",
    function (){
        var dateDebut=new Date(document.getElementById("dateDebut").value);
        var nbJours=parseInt(document.getElementById("nbJours").value);
        var dateFin=new Date(dateDebut);
    ...
    function (){
        var dateDebut=new Date(document.getElementById("dateDebut").value);
        var nbJours=parseInt(document.getElemsentById("nbJours").value);
        var dateFin=new Date(dateDebut);
        dateFin.setDate(dateFin.getDate()+nbJours).innerHTML=dateFin;
